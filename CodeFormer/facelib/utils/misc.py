...
# from CodeFormer.basicsr.utils.download_util import download_file_from_google_drive
...
def load_file_from_url(url, model_dir=None, progress=True, file_name=None):
    ...
    if not os.path.exists(cached_file):
        logger.error(f'Manual Downloading: "{url}" to {cached_file}\n')
        raise Exception(f"model not exist in local {cached_file}")
