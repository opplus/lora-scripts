...
def set_realesrgan():
    ...
    return upsampler
# python inference_codeformer.py -w 0.7 --only_center_face -i /app/lora-scripts/CodeFormer/inputs/test/test1.png
if __name__ == '__main__':
    ...
    if args.input_path.endswith(('jpg', 'jpeg', 'png', 'JPG', 'JPEG', 'PNG')): # input single img path
        ...
        from CodeFormer.basicsr.utils.video_util import VideoReader, VideoWriter
        input_img_list = []
